...
# from core.views.photo.views import router as photo_router
# from core.views.tags.views import router as tag_router
# from core.views.tags.views import user_tag_router
# from core.views.datastream.views import router as datastream_router
