...
class LocationFields(Schema):
    latitude: float = Field(..., ge=-90, le=90, validation_alias="location.latitude")
    longitude: float = Field(..., ge=-180, le=180, validation_alias="location.longitude")
    elevation_m: Optional[float] = Field(None, ge=-99999, le=99999, alias="elevation_m",
                                         validation_alias="location.elevation_m")
    elevation_datum: Optional[str] = Field(None, max_length=255, validation_alias="location.elevation_datum")
    state: Optional[str] = Field(None, max_length=200, validation_alias="location.state")
    county: Optional[str] = Field(None, max_length=200, validation_alias="location.county")
    country: Optional[str] = Field(None, max_length=2, validation_alias="location.country")
