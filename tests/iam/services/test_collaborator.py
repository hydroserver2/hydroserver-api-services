...
def test_create_collaborator(get_user, user, collaborator, workspace, role, message, error_code):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
...
def test_update_collaborator(get_user, user, collaborator, workspace, role, message, error_code):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
...
@pytest.mark.parametrize("user, collaborator, workspace, message, error_code", [
    ("owner", "editor", "b27c51a0-7374-462d-8a53-d97d47176c10", "Collaborator removed from workspace", None),
    ("admin", "editor", "b27c51a0-7374-462d-8a53-d97d47176c10", "Collaborator removed from workspace", None),
    ("editor", "viewer", "b27c51a0-7374-462d-8a53-d97d47176c10", "Collaborator removed from workspace", None),
    ("viewer", "viewer", "b27c51a0-7374-462d-8a53-d97d47176c10", "Collaborator removed from workspace", None),
    ("viewer", "editor", "b27c51a0-7374-462d-8a53-d97d47176c10", "You do not have permission", 403),
    ("anonymous", "editor", "6e0deaf2-a92b-421b-9ece-86783265596f", "You do not have permission", 403),
    ("anonymous", "editor", "b27c51a0-7374-462d-8a53-d97d47176c10", "Workspace does not exist", 404),
    ("owner", "fake", "b27c51a0-7374-462d-8a53-d97d47176c10", "No collaborator with email", 400),
    ("owner", "anonymous", "b27c51a0-7374-462d-8a53-d97d47176c10", "No collaborator with email", 400),
])
def test_delete_collaborator(get_user, user, collaborator, workspace, message, error_code):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
