...
@pytest.mark.parametrize('endpoint, entity_id, status_code', [
...
@pytest.mark.django_db()
def test_sensorthings_get_endpoints(django_test_db, auth_headers, base_url, endpoint, entity_id, status_code):
    client = Client()
