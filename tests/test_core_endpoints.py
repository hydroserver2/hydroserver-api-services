...
#     ('observed-properties', {}, 200, 5, 4),
#     ('observed-properties', {'owner': 'currentUser'}, 200, 3, 4),
#     ('observed-properties', {'owner': 'noUser'}, 200, 0, 4),
#     ('observed-properties', {'owner': 'currentUserOrNoUser'}, 200, 3, 4),
#     ('observed-properties', {'owner': 'anyUser'}, 200, 5, 4),
#     ('observed-properties', {'owner': 'anyUserOrNoUser'}, 200, 5, 4),
#     ('observed-properties', {'owner': 'fakeUser'}, 422, 1, 4),
#     ('processing-levels', {}, 200, 5, 4),
#     ('processing-levels', {'owner': 'currentUser'}, 200, 3, 4),
#     ('processing-levels', {'owner': 'noUser'}, 200, 0, 4),
#     ('processing-levels', {'owner': 'currentUserOrNoUser'}, 200, 3, 4),
#     ('processing-levels', {'owner': 'anyUser'}, 200, 5, 4),
#     ('processing-levels', {'owner': 'anyUserOrNoUser'}, 200, 5, 4),
#     ('processing-levels', {'owner': 'fakeUser'}, 422, 1, 4),
#     ('sensors', {}, 200, 5, 4),
#     ('sensors', {'owner': 'currentUser'}, 200, 3, 4),
#     ('sensors', {'owner': 'noUser'}, 200, 0, 4),
#     ('sensors', {'owner': 'currentUserOrNoUser'}, 200, 3, 4),
#     ('sensors', {'owner': 'anyUser'}, 200, 5, 4),
#     ('sensors', {'owner': 'anyUserOrNoUser'}, 200, 5, 4),
#     ('sensors', {'owner': 'fakeUser'}, 422, 1, 4),
#     ('things', {'modified_since': '2090-01-01T11:11:11Z'}, 200, 0, 4),
#     ('things', {'owned_only': True}, 200, 2, 4),
#     ('things', {'primary_owned_only': True}, 200, 1, 4),
#     ('units', {}, 200, 5, 4),
#     ('units', {'owner': 'currentUser'}, 200, 3, 4),
#     ('units', {'owner': 'noUser'}, 200, 0, 4),
#     ('units', {'owner': 'currentUserOrNoUser'}, 200, 3, 4),
#     ('units', {'owner': 'anyUser'}, 200, 5, 4),
#     ('units', {'owner': 'anyUserOrNoUser'}, 200, 5, 4),
#     ('units', {'owner': 'fakeUser'}, 422, 1, 4),
#     ('result-qualifiers', {}, 200, 5, 4),
#     ('result-qualifiers', {'owner': 'currentUser'}, 200, 3, 4),
#     ('result-qualifiers', {'owner': 'noUser'}, 200, 0, 4),
#     ('result-qualifiers', {'owner': 'currentUserOrNoUser'}, 200, 3, 4),
#     ('result-qualifiers', {'owner': 'anyUser'}, 200, 5, 4),
#     ('result-qualifiers', {'owner': 'anyUserOrNoUser'}, 200, 5, 4),
#     ('result-qualifiers', {'owner': 'fakeUser'}, 422, 1, 4),
# ])
