...
@pytest.mark.parametrize('endpoint, patch_body, response_code, max_queries', [
    ('datastreams/patch/ca999458-d644-44b0-b678-09a892fd54ac', {'name': 'string'}, 200, 100),
    ('observed-properties/97f5e0b8-e1e9-4c65-9b98-0438cdfb4a19', {'name': 'string'}, 200, 100),
    # ('processing-levels/83fdb8ba-5db4-4f31-b1fa-e68478a4be13', {'code': 'string'}, 200, 100),
    ('sensors/90d7f4a5-2042-4840-9bb4-b991f49cb8ed', {'name': 'string'}, 200, 100),
    ('things/9344a3d4-a45a-4529-b731-b51149b4d1b8', {'name': 'string'}, 203, 8),
    ('things/0c04fcdc-3876-429e-8260-14b7baca0231', {'name': 'string'}, 403, 4),
    ('things/00000000-0000-0000-0000-000000000000', {'name': 'string'}, 404, 4),
    ('units/52eac9d0-72ab-4f0e-933d-8ad8b8a8a1f9', {'name': 'string'}, 200, 4),
])
@pytest.mark.django_db()
...
@pytest.mark.parametrize('endpoint, response_code, max_queries', [
    ...
    ('things/0c04fcdc-3876-429e-8260-14b7baca0231', 403, 4),
    ('things/ab6d5d46-1ded-4ac6-8da8-0203df67950b', 403, 4),
    ('things/00000000-0000-0000-0000-000000000000', 404, 4)
])
@pytest.mark.django_db()
