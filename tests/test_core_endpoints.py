...
@pytest.mark.parametrize('endpoint, query_params, response_code, response_length, max_queries', [
    ...
    ('observed-properties', {'include_unowned': True}, 200, 5, 4),
    ('observed-properties', {'include_unowned': False}, 200, 3, 4),
    ('observed-properties', {'templates_only': True}, 200, 0, 4),
    ('observed-properties', {'templates_only': False}, 200, 3, 4),
    ('processing-levels', {}, 200, 3, 4),
    ('processing-levels', {'include_unowned': True}, 200, 5, 4),
    ('processing-levels', {'include_unowned': False}, 200, 3, 4),
    ('processing-levels', {'templates_only': True}, 200, 0, 4),
    ('processing-levels', {'templates_only': False}, 200, 3, 4),
    ('sensors', {}, 200, 3, 4),
    ('sensors', {'include_unowned': True}, 200, 5, 4),
    ('sensors', {'include_unowned': False}, 200, 3, 4),
    ('sensors', {'templates_only': True}, 200, 0, 4),
    ('sensors', {'templates_only': False}, 200, 3, 4),
    ('things', {'modified_since': '2090-01-01T11:11:11Z'}, 200, 0, 4),
    ('things', {'owned_only': True}, 200, 2, 4),
    ('things', {'primary_owned_only': True}, 200, 1, 4),
    ('units', {}, 200, 3, 4),
    ('units', {'include_unowned': True}, 200, 5, 4),
    ('units', {'include_unowned': False}, 200, 3, 4),
    ('units', {'templates_only': True}, 200, 0, 4),
    ('units', {'templates_only': False}, 200, 3, 4),
    ('result-qualifiers', {}, 200, 3, 4),
    ('result-qualifiers', {'include_unowned': True}, 200, 5, 4),
    ('result-qualifiers', {'include_unowned': False}, 200, 3, 4),
    ('result-qualifiers', {'templates_only': True}, 200, 0, 4),
    ('result-qualifiers', {'templates_only': False}, 200, 3, 4),
])
