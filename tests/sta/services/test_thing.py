...
@pytest.mark.parametrize("user, workspace, length, max_queries", [
    ("owner", None, 4, 4),
    ("owner", "b27c51a0-7374-462d-8a53-d97d47176c10", 2, 4),
    ("owner", "caf4b92e-6914-4449-8c8a-efa5a7fd1826", 0, 2),
    ("admin", None, 4, 4),
    ("admin", "b27c51a0-7374-462d-8a53-d97d47176c10", 2, 4),
    ("admin", "caf4b92e-6914-4449-8c8a-efa5a7fd1826", 0, 2),
    ("editor", None, 4, 4),
    ("editor", "b27c51a0-7374-462d-8a53-d97d47176c10", 2, 4),
    ("viewer", None, 4, 4),
    ("viewer", "b27c51a0-7374-462d-8a53-d97d47176c10", 2, 4),
    ("anonymous", None, 1, 5),
    ("anonymous", "6e0deaf2-a92b-421b-9ece-86783265596f", 1, 4),
    ("anonymous", "b27c51a0-7374-462d-8a53-d97d47176c10", 0, 2),
    ("anonymous", "00000000-0000-0000-0000-000000000000", 0, 2),
])
def test_list_thing(django_assert_max_num_queries, get_user, user, workspace, length, max_queries):
...
@pytest.mark.parametrize("user, thing, message, error_code", [
    ("owner", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "Utah Water Research Lab", None),
    ("owner", "76dadda5-224b-4e1f-8570-e385bd482b2d", "Taggart Student Center", None),
    ("owner", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "Old Main Building", None),
    ("owner", "819260c8-2543-4046-b8c4-7431243ed7c5", "Merrill-Cazier Library", None),
    ("admin", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "Utah Water Research Lab", None),
    ("admin", "76dadda5-224b-4e1f-8570-e385bd482b2d", "Taggart Student Center", None),
    ("admin", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "Old Main Building", None),
    ("admin", "819260c8-2543-4046-b8c4-7431243ed7c5", "Merrill-Cazier Library", None),
    ("editor", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "Utah Water Research Lab", None),
    ("editor", "76dadda5-224b-4e1f-8570-e385bd482b2d", "Taggart Student Center", None),
    ("editor", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "Old Main Building", None),
    ("editor", "819260c8-2543-4046-b8c4-7431243ed7c5", "Merrill-Cazier Library", None),
    ("viewer", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "Utah Water Research Lab", None),
    ("viewer", "76dadda5-224b-4e1f-8570-e385bd482b2d", "Taggart Student Center", None),
    ("viewer", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "Old Main Building", None),
    ("viewer", "819260c8-2543-4046-b8c4-7431243ed7c5", "Merrill-Cazier Library", None),
    ("anonymous", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "Utah Water Research Lab", None),
...
def test_create_thing(get_user, user, workspace, message, error_code):
    thing_data = ThingPostBody(
        name="New", description="New", sampling_feature_type="Site", sampling_feature_code="NEW", site_type="Site",
        latitude=0, longitude=0, is_private=False, workspace_id=uuid.UUID(workspace)
    )
    if error_code:
        with pytest.raises(HttpError) as exc_info:
            thing_service.create(
                user=get_user(user), data=thing_data
            )
        assert exc_info.value.status_code == error_code
        assert exc_info.value.message.startswith(message)
    else:
...
@pytest.mark.parametrize("user, thing, message, error_code", [
    ...
    ("viewer", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "You do not have permission", 403),
    ("viewer", "76dadda5-224b-4e1f-8570-e385bd482b2d", "You do not have permission", 403),
    ("viewer", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "You do not have permission", 403),
    ("viewer", "819260c8-2543-4046-b8c4-7431243ed7c5", "You do not have permission", 403),
    ("anonymous", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "You do not have permission", 403),
    ("anonymous", "76dadda5-224b-4e1f-8570-e385bd482b2d", "Thing does not exist", 404),
    ("anonymous", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "Thing does not exist", 404),
    ("anonymous", "819260c8-2543-4046-b8c4-7431243ed7c5", "Thing does not exist", 404),
    ("anonymous", "00000000-0000-0000-0000-000000000000", "Thing does not exist", 404),
...
def test_edit_thing(get_user, user, thing, message, error_code):
    thing_data = ThingPatchBody(
        name="New", description="New", sampling_feature_type="Site", sampling_feature_code="NEW", site_type="Site",
        latitude=0, longitude=0, is_private=False
    )
    if error_code:
        with pytest.raises(HttpError) as exc_info:
...
@pytest.mark.parametrize("user, thing, message, error_code, max_queries", [
    ("owner", "3b7818af-eff7-4149-8517-e5cad9dc22e1", None, None, 14),
    ("owner", "76dadda5-224b-4e1f-8570-e385bd482b2d", None, None, 14),
    ("owner", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", None, None, 14),
    ("owner", "819260c8-2543-4046-b8c4-7431243ed7c5", None, None, 14),
    ("admin", "3b7818af-eff7-4149-8517-e5cad9dc22e1", None, None, 14),
    ("admin", "76dadda5-224b-4e1f-8570-e385bd482b2d", None, None, 14),
    ("admin", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", None, None, 14),
    ("admin", "819260c8-2543-4046-b8c4-7431243ed7c5", None, None, 14),
    ("editor", "3b7818af-eff7-4149-8517-e5cad9dc22e1", None, None, 14),
    ("editor", "76dadda5-224b-4e1f-8570-e385bd482b2d", None, None, 14),
    ("editor", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", None, None, 14),
    ("editor", "819260c8-2543-4046-b8c4-7431243ed7c5", None, None, 14),
    ("viewer", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "You do not have permission", 403, 6),
    ("viewer", "76dadda5-224b-4e1f-8570-e385bd482b2d", "You do not have permission", 403, 6),
    ("viewer", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "You do not have permission", 403, 6),
    ("viewer", "819260c8-2543-4046-b8c4-7431243ed7c5", "You do not have permission", 403, 6),
    ("anonymous", "3b7818af-eff7-4149-8517-e5cad9dc22e1", "You do not have permission", 403, 6),
    ("anonymous", "76dadda5-224b-4e1f-8570-e385bd482b2d", "Thing does not exist", 404, 6),
    ("anonymous", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", "Thing does not exist", 404, 6),
    ("anonymous", "819260c8-2543-4046-b8c4-7431243ed7c5", "Thing does not exist", 404, 6),
    ("anonymous", "00000000-0000-0000-0000-000000000000", "Thing does not exist", 404, 6),
])
def test_delete_thing(django_assert_max_num_queries, get_user, user, thing, message, error_code, max_queries):
    with django_assert_max_num_queries(max_queries):
        if error_code:
            with pytest.raises(HttpError) as exc_info:
...
@pytest.mark.parametrize("user, thing, tag, message, error_code", [
    ...
    ("admin", "3b7818af-eff7-4149-8517-e5cad9dc22e1", {"key": "New Key", "value": "New Value"}, None, None),
    ("admin", "76dadda5-224b-4e1f-8570-e385bd482b2d", {"key": "New Key", "value": "New Value"}, None, None),
    ("admin", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", {"key": "New Key", "value": "New Value"}, None, None),
    ("admin", "819260c8-2543-4046-b8c4-7431243ed7c5", {"key": "New Key", "value": "New Value"}, None, None),
    ("editor", "3b7818af-eff7-4149-8517-e5cad9dc22e1", {"key": "New Key", "value": "New Value"}, None, None),
    ("editor", "76dadda5-224b-4e1f-8570-e385bd482b2d", {"key": "New Key", "value": "New Value"}, None, None),
    ("editor", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", {"key": "New Key", "value": "New Value"}, None, None),
    ("editor", "819260c8-2543-4046-b8c4-7431243ed7c5", {"key": "New Key", "value": "New Value"}, None, None),
    ("viewer", "3b7818af-eff7-4149-8517-e5cad9dc22e1", {"key": "New Key", "value": "New Value"}, "You do not have permission", 403),
    ("viewer", "76dadda5-224b-4e1f-8570-e385bd482b2d", {"key": "New Key", "value": "New Value"}, "You do not have permission", 403),
    ("viewer", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", {"key": "New Key", "value": "New Value"}, "You do not have permission", 403),
    ("viewer", "819260c8-2543-4046-b8c4-7431243ed7c5", {"key": "New Key", "value": "New Value"}, "You do not have permission", 403),
    ("anonymous", "3b7818af-eff7-4149-8517-e5cad9dc22e1", {"key": "New Key", "value": "New Value"}, "You do not have permission", 403),
    ("anonymous", "76dadda5-224b-4e1f-8570-e385bd482b2d", {"key": "New Key", "value": "New Value"}, "Thing does not exist", 404),
    ("anonymous", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", {"key": "New Key", "value": "New Value"}, "Thing does not exist", 404),
    ("anonymous", "819260c8-2543-4046-b8c4-7431243ed7c5", {"key": "New Key", "value": "New Value"}, "Thing does not exist", 404),
])
def test_add_tag(get_user, user, thing, tag, message, error_code):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
            thing_service.add_tag(
                user=get_user(user), uid=uuid.UUID(thing), data=TagPostBody(key=tag["key"], value=tag["value"])
            )
        assert exc_info.value.status_code == error_code
        assert exc_info.value.message.startswith(message)
    else:
    ...
    if error_code:
        with pytest.raises(HttpError) as exc_info:
            thing_service.remove_tag(
                user=get_user(user), uid=uuid.UUID(thing), data=TagDeleteBody(key=tag["key"])
            )
        assert exc_info.value.status_code == error_code
        assert exc_info.value.message.startswith(message)
    else:
