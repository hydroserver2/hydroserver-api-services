...
@pytest.mark.parametrize("user, thing, message, error_code, max_queries", [
    ...
    ("editor", "3b7818af-eff7-4149-8517-e5cad9dc22e1", None, None, 15),
    ("editor", "76dadda5-224b-4e1f-8570-e385bd482b2d", None, None, 15),
    ("editor", "92a3a099-f2d3-40ec-9b0e-d25ae8bf59b7", None, None, 15),
    ("editor", "819260c8-2543-4046-b8c4-7431243ed7c5", None, None, 15),
