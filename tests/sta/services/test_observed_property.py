...
@pytest.mark.parametrize("user, observed_property, message, error_code", [
    ("owner", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "System Observed Property", None),
    ("owner", "cac1262e-68ee-43a0-9222-f214f2161091", "Public Observed Property", None),
    ("owner", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "Private Observed Property", None),
    ("admin", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "System Observed Property", None),
    ("admin", "cac1262e-68ee-43a0-9222-f214f2161091", "Public Observed Property", None),
    ("admin", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "Private Observed Property", None),
    ("editor", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "System Observed Property", None),
    ("editor", "cac1262e-68ee-43a0-9222-f214f2161091", "Public Observed Property", None),
    ("editor", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "Private Observed Property", None),
    ("viewer", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "System Observed Property", None),
    ("viewer", "cac1262e-68ee-43a0-9222-f214f2161091", "Public Observed Property", None),
    ("viewer", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "Private Observed Property", None),
    ("anonymous", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "System Observed Property", None),
    ("anonymous", "cac1262e-68ee-43a0-9222-f214f2161091", "Public Observed Property", None),
    ("anonymous", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "Observed property does not exist", 404),
    ("anonymous", "00000000-0000-0000-0000-000000000000", "Observed property does not exist", 404),
])
...
def test_create_observed_property(get_user, user, workspace, message, error_code):
    observed_property_data = ObservedPropertyPostBody(
        name="New", code="New", description="New", definition="New", observed_property_type="New",
...
@pytest.mark.parametrize("user, observed_property, message, error_code", [
    ("owner", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "You do not have permission", 403),
    ...
    ("viewer", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "You do not have permission", 403),
    ("viewer", "cac1262e-68ee-43a0-9222-f214f2161091", "You do not have permission", 403),
    ("viewer", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "You do not have permission", 403),
    ("anonymous", "49a245bd-4517-4dea-b3ba-25c919bf2cf5", "You do not have permission", 403),
    ("anonymous", "cac1262e-68ee-43a0-9222-f214f2161091", "You do not have permission", 403),
    ("anonymous", "5dbfd184-ae79-4c05-a9ea-3f5e775ecbc1", "Observed property does not exist", 404),
    ("anonymous", "00000000-0000-0000-0000-000000000000", "Observed property does not exist", 404),
])
    ...
    if error_code:
        with pytest.raises(HttpError) as exc_info:
            observed_property_service.update(
                user=get_user(user), uid=uuid.UUID(observed_property), data=observed_property_data
            )
        assert exc_info.value.status_code == error_code
        assert exc_info.value.message.startswith(message)
    else:
...
def test_delete_observed_property(get_user, user, observed_property, message, error_code):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
