...
def test_list_etl_configuration(
    ...
    with django_assert_num_queries(max_queries):
        ...
        assert (
            EtlConfigurationGetResponse.from_orm(etl_configuration)
            for etl_configuration in etl_configuration_list
        )


@pytest.mark.parametrize(
    "user, etl_system_platform, etl_configuration, message, error_code",
    [
        (
            "admin",
            "ff0f462f-7456-40d7-93b6-77806176d08f",
            "0467a2dd-254c-49f4-9087-2e041f8ebc0c",
        ...
        (
            ...
            "Workspace Data Source Configuration",
            None,
        ),
        (
            "owner",
        ...
        (
            ...
            "b3d13d31-95a1-482e-a35b-ae24e78d519e",
            "0f73cc35-0cd5-45d3-9597-65877f84a924",
            "ETL configuration does not exist",
            404,
        ),
        (
            "anonymous",
...
def test_get_etl_configuration(
    get_user, user, etl_system_platform, etl_configuration, message, error_code
):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
            etl_configuration_service.get(
                user=get_user(user),
                uid=uuid.UUID(etl_configuration),
...
@pytest.mark.parametrize(
    "user, etl_system_platform, etl_configuration_schema, message, error_code",
    [
        (
            "admin",
            "ff0f462f-7456-40d7-93b6-77806176d08f",
...
def test_create_etl_configuration(
    get_user, user, etl_system_platform, etl_configuration_schema, message, error_code
):
...
@pytest.mark.parametrize(
    "user, etl_system_platform, etl_configuration, etl_configuration_schema, message, error_code",
    [
        (
            "admin",
            "ff0f462f-7456-40d7-93b6-77806176d08f",
...
def test_edit_etl_configuration(
    get_user,
    user,
    etl_system_platform,
    etl_configuration,
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "ff0f462f-7456-40d7-93b6-77806176d08f",
            "0467a2dd-254c-49f4-9087-2e041f8ebc0c",
            "ETL configuration in use",
            409,
        ),
        (
            "admin",
            "8fe5560d-483d-49d8-9bad-3b01d5ef3916",
            "46f2d592-3a06-4df5-bd86-6621a8f0c347",
            None,
            None,
        ),
        (
...
def test_delete_etl_configuration(
    get_user, user, etl_system_platform, etl_configuration, message, error_code
):
    if error_code:
        with pytest.raises(HttpError) as exc_info:
